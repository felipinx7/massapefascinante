      ...
      >
        ...
        <form className="flex w-full flex-col items-center gap-3">
          ...
          <div className="flex w-full flex-col items-start">
            ...
            {preview ? (
              //  Visualização da Nova Foto Adicionada
              <div className="relative h-[200px] w-full overflow-hidden">
                ...
                <div className="absolute left-0 top-0 h-full w-full p-2">
                  <div className="flex w-full items-end justify-end">
                    <div
                      onClick={preview ? deletePreviewPhoto : deletePhotoBackend}
          ...
          <div className="flex w-full flex-col items-start justify-start">
            ...
            <input type="text" className="w-full rounded border border-gray-300 p-2 text-sm" placeholder='Digite o nome do Author' />
          </div>

          {/* button of submited  */}
          <button className="w-full rounded bg-primargreen py-2 text-white">Atualizar Notícia</button>
        </form>
      </article>
    </section>,
