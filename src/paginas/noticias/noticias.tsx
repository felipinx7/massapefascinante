      ...
      <section className="m-0 mt-3 h-full w-[100%] max-w-[1280px] px-5">
        ...
        <div className="mt-3 flex w-full flex-col items-baseline rounded-md">
          ...
          <div className="flex h-auto w-full items-start justify-between gap-3 max-lg:flex-col">
            ...
            <div className="flex w-[450px] max-lg:overflow-y-hidden max-lg:w-full max-lg:gap-1 max-lg:h-80 overflow-y-hidden max-lg:justify-between max-md:overflow-scroll p-1 overflow-x-hidden justify-between max-lg:justify-start flex-col gap-5 max-lg:mt-4  max-lg:flex-row ">
